...
public class ImageActivity extends AppCompatActivity {
    ...
    private final static String IMAGE_URL ="https://t9.baidu.com/it/u=1717124604,1586043722&fm=193";//自己找的图片
            //"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1562328963756&di=9c0c6c839381c8314a3ce8e7db61deb2&imgtype=0&src=http%3A%2F%2Fpic13.nipic.com%2F20110316%2F5961966_124313527122_2.jpg";
    ...
    private void loadImage() {
        ...
        Glide.with(ImageActivity.this)
                .load(IMAGE_URL)
                .apply(cropOptions.transform(new CornersTransform(30)))
                .placeholder(R.drawable.icon_progress_bar)
                .error(R.drawable.loadingfail)
